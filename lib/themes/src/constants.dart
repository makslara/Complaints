...
const displayLarge = TextStyle(fontWeight: FontWeight.w500, fontSize: 16);
const displayMedium = TextStyle(fontWeight: FontWeight.w500, fontSize: 14);
const displaySmall = TextStyle(fontWeight: FontWeight.w500, fontSize: 12);
